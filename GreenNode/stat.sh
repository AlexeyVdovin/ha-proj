...
URL="http://192.168.88.2/greenhouse/stat.php?g1gr=${G1_GROUND_T}&g1grt=${G1_GROUND_TT}&g1ar=${G1_AIR_T}&g1art=${G1_AIR_TT}&g2gr=${G2_GROUND_T}&g2grt=${G2_GROUND_TT}&g2ar=${G2_AIR_T}&g2art=${G2_AIR_TT}&g1ht=${G1_HEAT}&g2ht=${G2_HEAT}&g1vt=${G1_VENT}&g2vt=${G2_VENT}&g1cr=${G1_CIRC}&g2cr=${G2_CIRC}" 
...
URL="http://192.168.88.2/greenhouse/bmc.php?piz3v3=${PIZ_3V3}&piz5v0=${PIZ_5V0}&ow3v3=${OW_3V3}&vcc12v=${VCC_12V}&acdc12v=${ACDC_12V}&status=${STATUS}&relay=${RELAY}" 
